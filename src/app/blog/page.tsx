  ...
  return (
    <>
      <Container>
        ...
        <div className="w-full bg-background rounded-lg border border-border">
          ...
          <p className="px-5 py-3">
            Cái chỗ để đăng tải mấy bài shitpost tôi viết 
            về đủ loại đề tài khác nhau không theo trật tự nào cả.
          </p>
          <p className="px-5 pb-3 font-semibold">
            Viết lung tung nhìn cho hay chứ không biết viết cái gì ở đây.
          </p>
        </div>
      ...
      <TextScroll
        ...
        text="Nora to Oujo to Noraneko Heart  "
      />
      <script
